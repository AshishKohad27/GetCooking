    ...
    <div className="auth-outer">
      <div className="site-conatiner">
        <div className="auth-inner">
          ...
          <form action="" className="auth-form" onSubmit={handleSubmit}>
            <div className="auth-name-box auth-box">
              <label htmlFor="auth-form-name">Name</label>
              <input
                type="text"
                id="auth-form-name"
                name="name"
                ...
                className={
                  submitted && !form.name ? "auth-empty-field" : "auth-normal"
                }
              />
            </div>
      ...
      <div className="auth-svg">
        <svg viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <radialGradient id="b" r="100%" cx="81%" cy="62%">
              <stop offset="0%" stop-color="#b9e7f7" />
              <stop offset="100%" stop-color="#e0ffff" />
            </radialGradient>
            <clipPath id="a">
              <path
                fill="currentColor"
                d="M803.5 664Q689 828 491 843.5t-329-164Q31 500 155.5 309t323-153q198.5 38 319 191t6 317Z"
              />
            </clipPath>
          </defs>
          <g clip-path="url(#a)">
